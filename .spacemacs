...
you should place your code here."
  ...
  (setq jiralib-url "https://parallel6.atlassian.net"))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "PragmataPro" :foundry "nil" :slant normal :weight normal :height 250 :width normal)))))
